"use client"
import { AppBar, Autocomplete, Box, Button, Dialog, DialogActions, DialogContent, Divider, Grid, IconButton, List, Slide, Stack, TextField, Toolbar, Typography } from "@mui/material"
  ...
  return (
    <Box sx={{ px: 1, py: 2 }}>
      ...
      >
        ...
        />
        <IconButton onClick={() => setOpenFilter(true)} size="small" aria-label="Filter books" color="secondary"><TuneIcon /></IconButton>
              ...
              <List sx={{ width: '100%', bgcolor: 'background.paper' }}>
                {
                  books.map((book, key) => (
                    <Box key={key}>
                      <BookListItem id={book.id} title={book.title} label={book.category_name} secondLabel={book.author_name} />
